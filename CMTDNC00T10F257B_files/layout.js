$(document).ready(function() {
	...
	*/
	$('.masthead_menu_body > ul > li.has-children:not(.masthead_usermenu_menu):not(.masthead_menu_body_comunita) > a').click(function() {
	...
	*/
	...
	$('[data-toggle="main-navigation"],[data-toggle="help"]').click(function(e){
